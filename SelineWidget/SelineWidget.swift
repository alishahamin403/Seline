...
struct SelineWidgetEntryView: View {
    ...
    // Dark gray color for ETAs and action buttons
    ...
    var mediumWidgetView: some View {
        HStack(spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 6) {
                // 4 Location ETAs (2x2 grid - icon on top, time below, no circles)
                VStack(spacing: 6) {
                    // Row 1 - Locations 1 & 2
                    HStack(spacing: 10) {
                        // Location 1
                ...
                HStack(spacing: 10) {
                    ...
                    Image(systemName: "square.and.pencil")
                        ...
                        .frame(maxWidth: .infinity)
                        .frame(height: 36)
                        .background(RoundedRectangle(cornerRadius: 6).fill(badgeBackgroundColor))
            ...
            VStack(spacing: 8) {
                ...
                HStack(spacing: 10) {
                    ...
                    Link(destination: googleMapsURL(lat: entry.location1Latitude, lon: entry.location1Longitude)) {
                        ...
                        .frame(maxWidth: .infinity)
                        .frame(height: 60)
                        .background(RoundedRectangle(cornerRadius: 10).fill(badgeBackgroundColor))
                    }
                    .buttonStyle(.plain)
