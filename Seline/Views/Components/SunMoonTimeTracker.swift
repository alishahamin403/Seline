...
struct SunMoonTimeTracker: View {
    ...
    var body: some View {
        ZStack {
            // Base half circle using existing design
            HalfCircleOutline()
            ...
            GeometryReader { geometry in
                ...
                let iconY = center.y - radius * sin(radians) // Subtract to go UP instead of down
